    ...
    with Session() as session:
        try:
            ...
            if readings:
                ...
                print(f"No Body Temperature readings found for patient_id: {patient_id}")
                return pd.DataFrame(), None  # Return an empty DataFrame if no readings found

        except Exception as e:
            print(f"Error while fetching Body Temperature readings for patient_id {patient_id}: {e}")
