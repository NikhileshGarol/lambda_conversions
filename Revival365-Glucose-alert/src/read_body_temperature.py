...
from db.temperature_readings2 import fetch_body_temperature_readings_for_specific_day
from db.UserDet import fetch_patient_details
import json

def get_body_temperature_data_as_json(mobile_number, specific_date=None,interval=None):
    df, error = fetch_body_temperature_readings_for_specific_day(mobile_number, specific_date, interval)
...
if __name__ == "__main__":
    mobile_number = '+918521345464'  # Replace with the actual mobile number
    specific_date = '2025-1-1'  # Specify the date in YYYY-MM-DD format
