from db.bp_readings2 import fetch_blood_pressure_readings_for_specific_day
from db.UserDet import fetch_patient_details
import json

def get_blood_pressure_data_as_json(mobile_number, specific_date=None,interval=None):
    df, error = fetch_blood_pressure_readings_for_specific_day(mobile_number, specific_date ,interval)
